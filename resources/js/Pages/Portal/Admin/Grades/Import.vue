...
const submit = () => {
    form.post('/portal/admin/students/import', {
        forceFormData: true,
        onSuccess: () => {
            clearFile();
        },
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-blue-800 space-y-1 list-disc list-inside">
                            ...
                            <li>New students will be created if not found</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-slate-600 mt-1">
                            Download our pre-formatted template with sample data and reference sheets for grades.
                        </p>
                        <p class="text-xs text-slate-500 mt-2">
                            <strong>Required columns:</strong> Student Name, Grade
                        </p>
                    </div>
                    <a 
